...
public class BuyProductWithExistingClientTest {
	...
	@Test
	public void buyProductWithExistingClient() {
		...
		registerClientStepGroups.loginExistingClient1(client.lastName, client.password);
	}
}
